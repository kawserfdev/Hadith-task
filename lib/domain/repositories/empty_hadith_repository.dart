...
class EmptyHadithRepository implements HadithRepository {
  ...
  Future<List<BookEntity>> getAllBooks() async {
    print('⚠️ Empty repository: getAllBooks called');
    return [];
  }
  
  @override
  Future<List<ChapterEntity>> getChaptersByBookId(int bookId) async {
    print('⚠️ Empty repository: getChaptersByBookId called with bookId=$bookId');
    return [];
  }
  
  @override
  Future<List<HadithEntity>> getHadithsByChapterId(int chapterId) async {
    print('⚠️ Empty repository: getHadithsByChapterId called with chapterId=$chapterId');
    return [];
  }
  
  @override
  Future<HadithEntity?> getHadithById(int hadithId) async {
    print('⚠️ Empty repository: getHadithById called with hadithId=$hadithId');
    return null;
  }
  
  @override
  Future<bool> verifyDatabaseConnection() async {
    print('⚠️ Empty repository: verifyDatabaseConnection called');
    return false;
  }
  
  @override
  Future<bool> bookExists(int bookId) async {
    print('⚠️ Empty repository: bookExists called with bookId=$bookId');
    return false;
  }
  
  @override
  Future<bool> chapterExists(int chapterId) async {
    print('⚠️ Empty repository: chapterExists called with chapterId=$chapterId');
    return false;
  }
  
  @override
  Future<Map<String, dynamic>> getDatabaseStats() async {
    print('⚠️ Empty repository: getDatabaseStats called');
    return {
      'connected': false,
      'bookCount': 0,
      'chapterCount': 0,
  ...
  Future<Map<String, dynamic>> getSampleData() async {
    print('⚠️ Empty repository: getSampleData called');
    return {
      'books': [],
      'chapters': [],
      'hadiths': [],
  ...
  Future<bool> checkDatabaseSchema() async {
    print('⚠️ Empty repository: checkDatabaseSchema called');
    return false;
  }
  
  @override
  Future<bool> createSampleChapters(int bookId) async {
    print('⚠️ Empty repository: createSampleChapters called with bookId=$bookId');
    return false;
  }
  
  @override
  Future<void> debugChapters(int bookId) async {
    print('⚠️ Empty repository: debugChapters called with bookId=$bookId');
  }
  
  @override
  Future<void> verifyChaptersTable() async {
    print('⚠️ Empty repository: verifyChaptersTable called');
  }
  
  @override
  Future<void> exploreAllTables() async {
    print('⚠️ Empty repository: exploreAllTables called');
  }
}